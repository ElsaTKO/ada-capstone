...
app.get('/scrape', function(req, res){
	url = 'http://www.seattlefoodtruck.com/index.php/trucks/';
	...
	request(url, function(error, response, html) {
      ...
      links.each(function() {
        truck_links.push($(this).attr("href"));
      });
      // var json = { truck_links: [] };
      console.log(truck_links);
...
// [ 'http://www.seattlefoodtruck.com/index.php/trucks/314-pie/',
