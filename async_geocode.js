// NOTE: I WROTE THIS MONSTER WITHOUT UNDERSTANDING CALLBACKS
// AND SPENT A WEEK TRYING TO FRANKENSTEIN IT INTO WORKING
// WHILE RAPIDLY RUNNING OUT OF TIME TO SPEND ON DATA COLLECTION
// INSTEAD OF ACTUAL APPLICATION DEVELOPMENT
...
app.get('/google', function openConnection(req, res) {
  ...
  async.forEachOfSeries(old_food_trucks, function iterator(truck_json, index, iteratorCallback) {
    ...
    if (index < 118) { // for truck at this index
